...
The continuous normalizing flow estimates $p(\beta|\mathbf{\alpha}), \beta \in \\mathbb{R}, \mathbf{\alpha} \in \\mathbb{R}^{10}$, where $\beta$ is the extreme value parameter serving as a local
